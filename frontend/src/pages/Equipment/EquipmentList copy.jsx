  ...
  return (
    <div className="inline-flex items-center gap-2">
      <select
        ...
        className="px-3 py-2 text-sm rounded-md border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900"
      >
        {opts.map(([k, l]) => (
      ...
      <button
        ...
        className="px-2 py-2 rounded-md border border-slate-200 dark:border-slate-700 bg-white/70 dark:bg-slate-900/50 hover:bg-white dark:hover:bg-slate-800"
...
const Pagination = ({ page, pageCount, setPage }) => {
  ...
  return (
    <div className="mt-4 flex items-center justify-center gap-2">
      <button
        onClick={() => go(page - 1)}
        className="px-3 py-1 text-sm rounded-md border border-slate-200 dark:border-slate-700 bg-white/70 dark:bg-slate-900/50 hover:bg-white dark:hover:bg-slate-800"
      >
        Prev
      </button>
...
const EmptyState = ({ onClear }) => {
  return (
    <div className="mt-10 rounded-md border border-dashed border-slate-300 dark:border-slate-700 p-10 text-center bg-white/60 dark:bg-slate-900/40">
