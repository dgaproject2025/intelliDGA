    ...
    <>
      ...
      <div className="mt-6 space-y-8 max-h-[600px] overflow-y-auto pr-4">
        <div className="p-6 bg-white/50 dark:bg-slate-800/50 rounded-xl shadow-md border border-slate-200 dark:border-blue-500">
          ...
          {/* ENHANCED: More detailed description */}
          <div className="mt-3 space-y-3 text-sm text-slate-600 dark:text-slate-300 text-justify">
            <p>
              The Gouda Triangle method was developed as a graphical technique
              to resolve some of the inconsistencies and uncertainties that can
              arise when using the Duval Triangle 1. It operates on a similar
              principle of plotting gas concentrations on a triangular graph but
              uses a different set of three unique gas ratios to define the
              coordinates.
            </p>
            <p>
              This approach offers a higher diagnostic accuracy of{' '}
              <strong>85.42%</strong>, which is a notable improvement compared
              to the Duval Triangle (77.21%), IEC method (56.58%), and other
              foundational techniques. By providing an alternative visual
              analysis, it serves as a powerful tool for confirming or
        ...
        <div className="p-6 bg-white/50 dark:bg-slate-800/50 rounded-xl shadow-md border border-slate-200 dark:border-blue-500">
          ...
          <div className="mt-4 space-y-4 text-slate-600 dark:text-slate-300">
            <p className="text-sm text-justify">
              The method uses three ratios (R₁, R₂, R₃) to calculate percentage
              coordinates (P₁, P₂, P₃) for plotting, where S is the sum of the
              ratios (S = R₁ + R₂ + R₃).
            </p>
        ...
        <div className="p-6 bg-white/50 dark:bg-slate-800/50 rounded-xl shadow-md border border-slate-200 dark:border-blue-500">
          ...
          {/* ENHANCED: More descriptive interpretations */}
          <ul className="mt-3 list-disc pl-5 space-y-2 text-sm text-slate-600 dark:text-slate-300 text-justify">
            <li>
              ...
              electrical discharges, often of the corona type.
            </li>
            <li>
              <strong>T₁ (Thermal Fault ≤ 300°C):</strong> Represents
              low-temperature overheating, where paper may turn brownish but is
              not yet carbonized.
            </li>
            <li>
              <strong>T₂ (Thermal Fault 300-700°C):</strong> A
              medium-temperature thermal fault indicating more significant
              overheating that leads to paper carbonization.
            </li>
            <li>
              <strong>T₃ (Thermal Fault &gt; 700°C):</strong> A high-temperature
              thermal fault suggesting severe overheating with extensive
              carbonization of oil and potential metal damage.
            </li>
            <li>
              <strong>D₁ (Low Energy Discharge):</strong> Corresponds to
              sparking, a more energetic fault than PD that can cause punctures
              or tracking on insulation.
            </li>
            <li>
              <strong>D₂ (High Energy Discharge):</strong> Represents severe,
              high-energy arcing that can cause extensive damage to the
              transformer.
            </li>
            <li>
              <strong>DT (Mixed Fault):</strong> A complex scenario indicating a
              combination of both thermal and electrical faults occurring
              simultaneously.
            </li>
          </ul>
        </div>
