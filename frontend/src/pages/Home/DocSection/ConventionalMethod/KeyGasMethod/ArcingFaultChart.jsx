  ...
  return (
    <div className="mt-8 p-6 bg-slate-100 dark:bg-black/80 rounded-xl shadow-lg border border-slate-200 dark:border-blue-500/50">
      ...
      <p className="text-center text-sm text-slate-500 dark:text-gray-400 mt-2">
        Typical relative proportion of gases in arc type fault.
      </p>

      <div className="mt-4 pt-4 border-t border-slate-200 dark:border-blue-500/30 text-slate-700 dark:text-white">
        <ul className="space-y-2 list-disc pl-5 text-sm">
          <li>
            The formation of faults with arcing can reach temperatures between
            2000 and 3000 °C, and large amounts of H₂ and C₂H₂ and small amounts
            of CH₄ and C₂H₄ are produced.
          </li>
          <li>CO and CO₂ can be produced if the failure involves cellulose.</li>
          <li>Key gas: C₂H₂.</li>
        </ul>
      </div>
    </div>
...
export default ArcingFaultChart;
